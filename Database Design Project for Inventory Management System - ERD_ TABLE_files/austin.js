...
var keys=apstag.targetingKeys();for(var i=0;i<bids.length;i++){var bid=bids[i];for(var k=0;k<keys.length;k++){if(keys[k]in bid){if(typeof __ez.fads!=='undefined'){__ez.fads.cmd.push(function(){__ez.fads.ezSetSlotTargeting(bid.slotID,keys[k],bid[keys[k]]);});}else{ezSetSlotTargeting(bid.slotID,keys[k],bid[keys[k]]);}}}}}
